...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <a href='menu_gerenciar_empresa.php'  class="get-started-btn scrollto">Voltar</a>
        ...
        <div class="col-xl-6 col-lg-8">
          ...
          <br>
                <div class='rolagem'><?php
                        ...
                        $buscar=mysqli_query($conectar,"select * from empresa order by cidade, nome");
                        if(mysqli_num_rows($buscar)==0)
                            echo "Nenhuma empresa foi encontrada!<p>";
                        else{
                            while($encontrou=mysqli_fetch_array($buscar)){
                                echo "<p>ID: ".$encontrou[0]."<p>";                         
                                echo "<p>Nome: ".$encontrou[1]."<p>";
                                echo "<p>Endereço: ".$encontrou[2]."<p>";
                                echo "<p>Número: ".$encontrou[3]."<p>";
                                echo "<p>Bairro: ".$encontrou[4]."<p>";
                                echo "<p>Cidade: ".$encontrou[5]."<p>";
                                echo "<p>Telefone: ".$encontrou[6]."<p>";
                                echo "<p>--------------------------------------------------------- <p>";
                            }   
                        }
                    ?></div>
