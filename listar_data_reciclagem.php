...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <a href='menu_listar_reciclagem.php'  class="get-started-btn scrollto">Voltar</a>
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
        <div class="col-xl-6 col-lg-8">
          ...
          <h2>Listagem de reciclagem</h2><p>
          <br>
                <div class='rolagem'><?php
                        include "conexao/conectar.php";
                        $buscar=mysqli_query($conectar,"select * from listagem_recicla order by data_reciclagem");
                        if(mysqli_num_rows($buscar)==0)
                            echo "Nenhuma reciclagem foi encontrada!<p>";
                        else{
                            while($encontrou=mysqli_fetch_array($buscar)){
                                echo "<p>Nome da empresa: ".$encontrou[0]."<p>";                         
                                echo "<p>Descricão do produto: ".$encontrou[1]."<p>";
                                echo "<p>Data: ".$encontrou[2]."<p>";
                                echo "<p>Valor: ".$encontrou[3]."<p>";
                                echo "<p>Peso: ".$encontrou[4]."<p>";
                                echo "<p>--------------------------------------------------------- <p>";
                            }   
                        }
                    ?></div>
