      ...
      <div class="row gy-4 mt-5 justify-content-center" data-aos="zoom-in" data-aos-delay="250">
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            ...
            <h3><a href="menu_gerenciar_empresa.php">Gerenciar Empresa</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            <i class="ri-bar-chart-box-line"></i>
            <h3><a href="menu_gerenciar_produto.php">Gerenciar Produto</a></h3>
          </div>
        </div>
        <div class="col-xl-2 col-md-4">
          <div class="icon-box">
            <i class="ri-bar-chart-box-line"></i>
            <h3><a href="menu_gerenciar_reciclagem.php">Gerenciar Reciclagem</a></h3>
          </div>
        </div>
    </div>
  </section><!-- End Hero -->
