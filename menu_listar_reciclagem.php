...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <a href="menu_gerenciar_reciclagem.php" class="get-started-btn scrollto">Voltar</a>
        ...
        <div class="row gy-4 mt-5 justify-content-center" data-aos="zoom-in" data-aos-delay="250">
            <div class="col-xl-2 col-md-4">
                <div class="icon-box">
                    ...
                    <h3><a href="listar_data_reciclagem.php">Listagem ordenada pela data</a></h3>
                </div>
            </div>
            <div class="col-xl-2 col-md-4">
                <div class="icon-box">
                    <i class="ri-store-line"></i>
                    <h3><a href="listar_reciclagem.php">Listagem ordenada pelo produto</a></h3>
                </div>
            </div>
            <br>
        </div>
